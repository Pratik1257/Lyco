...
export default function ExpiryCard() {
  ...
  return (
    <div className="relative max-w-[1400px] mx-auto space-y-3">
        ...
        {/* Page Header */}
        <div className="mb-2">
          <h1 className="text-2xl font-black text-gray-900 tracking-tight">Card Expiry Summary</h1>
          <p className="text-gray-500 mt-0.5 text-sm font-medium">Overview of all customer credit cards and their expiry status.</p>
        </div>
