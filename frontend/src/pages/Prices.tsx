...
import { Plus, Edit2, X, ChevronDown, AlertCircle, Loader2, Tag } from 'lucide-react';
  ...
  return (
    <div className="relative max-w-6xl mx-auto space-y-2">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        {/* Compact Pro Header */}
        <div className="py-3 px-6 border-b border-gray-100 bg-slate-50/30 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 shrink-0">
            ...
            <h1 className="text-base font-black text-slate-900 tracking-tight leading-none">Manage Pricing</h1>
          </div>
          ...
          <div className="flex items-center gap-3 flex-1 justify-end">
            ...
            >
              <Plus size={18} />
              Add {activeTab === 'general' ? 'General' : 'Userwise'}
            </Button>
          </div>
        </div>
                  ...
                  {activeTab === 'general' ? (
                    ...
                    <div className="flex items-start gap-4 pt-1">
                      ...
                      <div className="flex-[0.6]">
                        ...
                        <div className={`flex flex-col justify-center h-[42px] px-4 rounded-[20px] border mt-0.5 transition-colors ${baselinePrice !== null
